...
type AskHelpResponse struct {
	...
	// Always false in this phase; reserved for phase 2 parking.
...
const file_cloche_proto_rawDesc = "" +
	...
	"\x02id\x18\x02 \x01(\tR\x02id\"\xe7\x04\n" +
	...
	"\x12pending_help_title\x18\x10 \x01(\tR\x10pendingHelpTitle\"\x8d\x02\n" +
	...
	"\x04runs\x18\x01 \x03(\v2\x15.cloche.v1.RunSummaryR\x04runs\"\xf2\x03\n" +
	"\n" +
	"RunSummary\x12\x15\n" +
	"\x06run_id\x18\x01 \x01(\tR\x05runId\x12#\n" +
	"\rworkflow_name\x18\x02 \x01(\tR\fworkflowName\x12\x14\n" +
	...
	"\x12pending_help_title\x18\x0f \x01(\tR\x10pendingHelpTitle\"o\n" +
	...
	"\routput_tokens\x18\x02 \x01(\x03R\foutputTokens\"\xfe\x01\n" +
...
var file_cloche_proto_msgTypes = make([]protoimpl.MessageInfo, 80)
var file_cloche_proto_goTypes = []any{
	...
	(*Shutdown)(nil),                // 66: cloche.v1.Shutdown
	(*TokenUsage)(nil),              // 67: cloche.v1.TokenUsage
	(*AskHelpRequest)(nil),          // 68: cloche.v1.AskHelpRequest
	(*AskHelpResponse)(nil),         // 69: cloche.v1.AskHelpResponse
	(*ListThreadsRequest)(nil),      // 70: cloche.v1.ListThreadsRequest
	(*HelpThreadSummary)(nil),       // 71: cloche.v1.HelpThreadSummary
	(*ListThreadsResponse)(nil),     // 72: cloche.v1.ListThreadsResponse
	(*GetThreadRequest)(nil),        // 73: cloche.v1.GetThreadRequest
	(*HelpMessageEntry)(nil),        // 74: cloche.v1.HelpMessageEntry
	(*GetThreadResponse)(nil),       // 75: cloche.v1.GetThreadResponse
	(*ReplyThreadRequest)(nil),      // 76: cloche.v1.ReplyThreadRequest
	(*ReplyThreadResponse)(nil),     // 77: cloche.v1.ReplyThreadResponse
	nil,                             // 78: cloche.v1.ExecuteStep.ConfigEntry
	nil,                             // 79: cloche.v1.HostWorkflowRequest.EnvEntry
}
var file_cloche_proto_depIdxs = []int32{
	...
	66, // 19: cloche.v1.DaemonMessage.shutdown:type_name -> cloche.v1.Shutdown
	78, // 20: cloche.v1.ExecuteStep.config:type_name -> cloche.v1.ExecuteStep.ConfigEntry
	67, // 21: cloche.v1.StepResult.token_usage:type_name -> cloche.v1.TokenUsage
	79, // 22: cloche.v1.HostWorkflowRequest.env:type_name -> cloche.v1.HostWorkflowRequest.EnvEntry
	71, // 23: cloche.v1.ListThreadsResponse.threads:type_name -> cloche.v1.HelpThreadSummary
	71, // 24: cloche.v1.GetThreadResponse.thread:type_name -> cloche.v1.HelpThreadSummary
	74, // 25: cloche.v1.GetThreadResponse.messages:type_name -> cloche.v1.HelpMessageEntry
	0,  // 26: cloche.v1.ClocheService.RunWorkflow:input_type -> cloche.v1.RunWorkflowRequest
	2,  // 27: cloche.v1.ClocheService.GetStatus:input_type -> cloche.v1.GetStatusRequest
	5,  // 28: cloche.v1.ClocheService.StreamLogs:input_type -> cloche.v1.StreamLogsRequest
	7,  // 29: cloche.v1.ClocheService.StopRun:input_type -> cloche.v1.StopRunRequest
	15, // 30: cloche.v1.ClocheService.ListRuns:input_type -> cloche.v1.ListRunsRequest
	31, // 31: cloche.v1.ClocheService.ListTasks:input_type -> cloche.v1.ListTasksRequest
	34, // 32: cloche.v1.ClocheService.GetTask:input_type -> cloche.v1.GetTaskRequest
	37, // 33: cloche.v1.ClocheService.GetAttempt:input_type -> cloche.v1.GetAttemptRequest
	9,  // 34: cloche.v1.ClocheService.Shutdown:input_type -> cloche.v1.ShutdownRequest
	11, // 35: cloche.v1.ClocheService.DeleteContainer:input_type -> cloche.v1.DeleteContainerRequest
	13, // 36: cloche.v1.ClocheService.ExtractRun:input_type -> cloche.v1.ExtractRunRequest
	18, // 37: cloche.v1.ClocheService.EnableLoop:input_type -> cloche.v1.EnableLoopRequest
	20, // 38: cloche.v1.ClocheService.DisableLoop:input_type -> cloche.v1.DisableLoopRequest
	22, // 39: cloche.v1.ClocheService.ResumeLoop:input_type -> cloche.v1.ResumeLoopRequest
	24, // 40: cloche.v1.ClocheService.QuiesceRuns:input_type -> cloche.v1.QuiesceRunsRequest
	26, // 41: cloche.v1.ClocheService.GetProjectInfo:input_type -> cloche.v1.GetProjectInfoRequest
	29, // 42: cloche.v1.ClocheService.GetVersion:input_type -> cloche.v1.GetVersionRequest
	39, // 43: cloche.v1.ClocheService.Complete:input_type -> cloche.v1.CompleteRequest
	41, // 44: cloche.v1.ClocheService.GetUsage:input_type -> cloche.v1.GetUsageRequest
	44, // 45: cloche.v1.ClocheService.Console:input_type -> cloche.v1.ConsoleInput
	50, // 46: cloche.v1.ClocheService.GetContextKey:input_type -> cloche.v1.GetContextKeyRequest
	52, // 47: cloche.v1.ClocheService.SetContextKey:input_type -> cloche.v1.SetContextKeyRequest
	54, // 48: cloche.v1.ClocheService.ListContextKeys:input_type -> cloche.v1.ListContextKeysRequest
	56, // 49: cloche.v1.ClocheService.AgentSession:input_type -> cloche.v1.AgentMessage
	68, // 50: cloche.v1.ClocheService.AskHelp:input_type -> cloche.v1.AskHelpRequest
	70, // 51: cloche.v1.ClocheService.ListThreads:input_type -> cloche.v1.ListThreadsRequest
	73, // 52: cloche.v1.ClocheService.GetThread:input_type -> cloche.v1.GetThreadRequest
	76, // 53: cloche.v1.ClocheService.ReplyThread:input_type -> cloche.v1.ReplyThreadRequest
	1,  // 54: cloche.v1.ClocheService.RunWorkflow:output_type -> cloche.v1.RunWorkflowResponse
	3,  // 55: cloche.v1.ClocheService.GetStatus:output_type -> cloche.v1.GetStatusResponse
	6,  // 56: cloche.v1.ClocheService.StreamLogs:output_type -> cloche.v1.LogEntry
	8,  // 57: cloche.v1.ClocheService.StopRun:output_type -> cloche.v1.StopRunResponse
	16, // 58: cloche.v1.ClocheService.ListRuns:output_type -> cloche.v1.ListRunsResponse
	33, // 59: cloche.v1.ClocheService.ListTasks:output_type -> cloche.v1.ListTasksResponse
	36, // 60: cloche.v1.ClocheService.GetTask:output_type -> cloche.v1.GetTaskResponse
	38, // 61: cloche.v1.ClocheService.GetAttempt:output_type -> cloche.v1.GetAttemptResponse
	10, // 62: cloche.v1.ClocheService.Shutdown:output_type -> cloche.v1.ShutdownResponse
	12, // 63: cloche.v1.ClocheService.DeleteContainer:output_type -> cloche.v1.DeleteContainerResponse
	14, // 64: cloche.v1.ClocheService.ExtractRun:output_type -> cloche.v1.ExtractRunResponse
	19, // 65: cloche.v1.ClocheService.EnableLoop:output_type -> cloche.v1.EnableLoopResponse
	21, // 66: cloche.v1.ClocheService.DisableLoop:output_type -> cloche.v1.DisableLoopResponse
	23, // 67: cloche.v1.ClocheService.ResumeLoop:output_type -> cloche.v1.ResumeLoopResponse
	25, // 68: cloche.v1.ClocheService.QuiesceRuns:output_type -> cloche.v1.QuiesceRunsResponse
	28, // 69: cloche.v1.ClocheService.GetProjectInfo:output_type -> cloche.v1.GetProjectInfoResponse
	30, // 70: cloche.v1.ClocheService.GetVersion:output_type -> cloche.v1.GetVersionResponse
	40, // 71: cloche.v1.ClocheService.Complete:output_type -> cloche.v1.CompleteResponse
	42, // 72: cloche.v1.ClocheService.GetUsage:output_type -> cloche.v1.GetUsageResponse
	45, // 73: cloche.v1.ClocheService.Console:output_type -> cloche.v1.ConsoleOutput
	51, // 74: cloche.v1.ClocheService.GetContextKey:output_type -> cloche.v1.GetContextKeyResponse
	53, // 75: cloche.v1.ClocheService.SetContextKey:output_type -> cloche.v1.SetContextKeyResponse
	55, // 76: cloche.v1.ClocheService.ListContextKeys:output_type -> cloche.v1.ListContextKeysResponse
	57, // 77: cloche.v1.ClocheService.AgentSession:output_type -> cloche.v1.DaemonMessage
	69, // 78: cloche.v1.ClocheService.AskHelp:output_type -> cloche.v1.AskHelpResponse
	72, // 79: cloche.v1.ClocheService.ListThreads:output_type -> cloche.v1.ListThreadsResponse
	75, // 80: cloche.v1.ClocheService.GetThread:output_type -> cloche.v1.GetThreadResponse
	77, // 81: cloche.v1.ClocheService.ReplyThread:output_type -> cloche.v1.ReplyThreadResponse
