...
const file_cloche_proto_rawDesc = "" +
	...
	"\x13ReplyThreadResponse2\xbd\x10\n" +
	"\rClocheService\x12L\n" +
...
var file_cloche_proto_msgTypes = make([]protoimpl.MessageInfo, 81)
var file_cloche_proto_goTypes = []any{
	...
	(*GetVersionRequest)(nil),       // 29: cloche.v1.GetVersionRequest
	(*GetVersionResponse)(nil),      // 30: cloche.v1.GetVersionResponse
	(*ListTasksRequest)(nil),        // 31: cloche.v1.ListTasksRequest
	(*TaskSummary)(nil),             // 32: cloche.v1.TaskSummary
	(*ListTasksResponse)(nil),       // 33: cloche.v1.ListTasksResponse
	(*GetTaskRequest)(nil),          // 34: cloche.v1.GetTaskRequest
	(*AttemptSummary)(nil),          // 35: cloche.v1.AttemptSummary
	(*GetTaskResponse)(nil),         // 36: cloche.v1.GetTaskResponse
	(*GetAttemptRequest)(nil),       // 37: cloche.v1.GetAttemptRequest
	(*GetAttemptResponse)(nil),      // 38: cloche.v1.GetAttemptResponse
	(*CompleteRequest)(nil),         // 39: cloche.v1.CompleteRequest
	(*CompleteResponse)(nil),        // 40: cloche.v1.CompleteResponse
	(*GetUsageRequest)(nil),         // 41: cloche.v1.GetUsageRequest
	(*GetUsageResponse)(nil),        // 42: cloche.v1.GetUsageResponse
	(*UsageSummary)(nil),            // 43: cloche.v1.UsageSummary
	(*ConsoleInput)(nil),            // 44: cloche.v1.ConsoleInput
	(*ConsoleOutput)(nil),           // 45: cloche.v1.ConsoleOutput
	(*ConsoleStart)(nil),            // 46: cloche.v1.ConsoleStart
	(*ConsoleStarted)(nil),          // 47: cloche.v1.ConsoleStarted
	(*TerminalSize)(nil),            // 48: cloche.v1.TerminalSize
	(*ConsoleExited)(nil),           // 49: cloche.v1.ConsoleExited
	(*GetContextKeyRequest)(nil),    // 50: cloche.v1.GetContextKeyRequest
	(*GetContextKeyResponse)(nil),   // 51: cloche.v1.GetContextKeyResponse
	(*SetContextKeyRequest)(nil),    // 52: cloche.v1.SetContextKeyRequest
	(*SetContextKeyResponse)(nil),   // 53: cloche.v1.SetContextKeyResponse
	(*ListContextKeysRequest)(nil),  // 54: cloche.v1.ListContextKeysRequest
	(*ListContextKeysResponse)(nil), // 55: cloche.v1.ListContextKeysResponse
	(*AgentMessage)(nil),            // 56: cloche.v1.AgentMessage
	(*DaemonMessage)(nil),           // 57: cloche.v1.DaemonMessage
	(*AgentReady)(nil),              // 58: cloche.v1.AgentReady
	(*ExecuteStep)(nil),             // 59: cloche.v1.ExecuteStep
	(*StepResult)(nil),              // 60: cloche.v1.StepResult
	(*StepLog)(nil),                 // 61: cloche.v1.StepLog
	(*StepStarted)(nil),             // 62: cloche.v1.StepStarted
	(*HostWorkflowRequest)(nil),     // 63: cloche.v1.HostWorkflowRequest
	(*HostWorkflowResult)(nil),      // 64: cloche.v1.HostWorkflowResult
	(*StepCancelled)(nil),           // 65: cloche.v1.StepCancelled
	(*ParkStep)(nil),                // 66: cloche.v1.ParkStep
	(*Shutdown)(nil),                // 67: cloche.v1.Shutdown
	(*TokenUsage)(nil),              // 68: cloche.v1.TokenUsage
	(*AskHelpRequest)(nil),          // 69: cloche.v1.AskHelpRequest
	(*AskHelpResponse)(nil),         // 70: cloche.v1.AskHelpResponse
	(*ListThreadsRequest)(nil),      // 71: cloche.v1.ListThreadsRequest
	(*HelpThreadSummary)(nil),       // 72: cloche.v1.HelpThreadSummary
	(*ListThreadsResponse)(nil),     // 73: cloche.v1.ListThreadsResponse
	(*GetThreadRequest)(nil),        // 74: cloche.v1.GetThreadRequest
	(*HelpMessageEntry)(nil),        // 75: cloche.v1.HelpMessageEntry
	(*GetThreadResponse)(nil),       // 76: cloche.v1.GetThreadResponse
	(*ReplyThreadRequest)(nil),      // 77: cloche.v1.ReplyThreadRequest
	(*ReplyThreadResponse)(nil),     // 78: cloche.v1.ReplyThreadResponse
	nil,                             // 79: cloche.v1.ExecuteStep.ConfigEntry
	nil,                             // 80: cloche.v1.HostWorkflowRequest.EnvEntry
}
var file_cloche_proto_depIdxs = []int32{
	...
	32, // 4: cloche.v1.ListTasksResponse.tasks:type_name -> cloche.v1.TaskSummary
	35, // 5: cloche.v1.GetTaskResponse.attempts:type_name -> cloche.v1.AttemptSummary
	43, // 6: cloche.v1.GetUsageResponse.summaries:type_name -> cloche.v1.UsageSummary
	46, // 7: cloche.v1.ConsoleInput.start:type_name -> cloche.v1.ConsoleStart
	48, // 8: cloche.v1.ConsoleInput.resize:type_name -> cloche.v1.TerminalSize
	47, // 9: cloche.v1.ConsoleOutput.started:type_name -> cloche.v1.ConsoleStarted
	49, // 10: cloche.v1.ConsoleOutput.exited:type_name -> cloche.v1.ConsoleExited
	58, // 11: cloche.v1.AgentMessage.ready:type_name -> cloche.v1.AgentReady
	60, // 12: cloche.v1.AgentMessage.step_result:type_name -> cloche.v1.StepResult
	61, // 13: cloche.v1.AgentMessage.step_log:type_name -> cloche.v1.StepLog
	62, // 14: cloche.v1.AgentMessage.step_started:type_name -> cloche.v1.StepStarted
	63, // 15: cloche.v1.AgentMessage.host_request:type_name -> cloche.v1.HostWorkflowRequest
	59, // 16: cloche.v1.DaemonMessage.execute_step:type_name -> cloche.v1.ExecuteStep
	65, // 17: cloche.v1.DaemonMessage.step_cancelled:type_name -> cloche.v1.StepCancelled
	64, // 18: cloche.v1.DaemonMessage.host_result:type_name -> cloche.v1.HostWorkflowResult
	67, // 19: cloche.v1.DaemonMessage.shutdown:type_name -> cloche.v1.Shutdown
	66, // 20: cloche.v1.DaemonMessage.park_step:type_name -> cloche.v1.ParkStep
	79, // 21: cloche.v1.ExecuteStep.config:type_name -> cloche.v1.ExecuteStep.ConfigEntry
	68, // 22: cloche.v1.StepResult.token_usage:type_name -> cloche.v1.TokenUsage
	80, // 23: cloche.v1.HostWorkflowRequest.env:type_name -> cloche.v1.HostWorkflowRequest.EnvEntry
	72, // 24: cloche.v1.ListThreadsResponse.threads:type_name -> cloche.v1.HelpThreadSummary
	72, // 25: cloche.v1.GetThreadResponse.thread:type_name -> cloche.v1.HelpThreadSummary
	75, // 26: cloche.v1.GetThreadResponse.messages:type_name -> cloche.v1.HelpMessageEntry
	0,  // 27: cloche.v1.ClocheService.RunWorkflow:input_type -> cloche.v1.RunWorkflowRequest
	2,  // 28: cloche.v1.ClocheService.GetStatus:input_type -> cloche.v1.GetStatusRequest
	5,  // 29: cloche.v1.ClocheService.StreamLogs:input_type -> cloche.v1.StreamLogsRequest
	7,  // 30: cloche.v1.ClocheService.StopRun:input_type -> cloche.v1.StopRunRequest
	15, // 31: cloche.v1.ClocheService.ListRuns:input_type -> cloche.v1.ListRunsRequest
	31, // 32: cloche.v1.ClocheService.ListTasks:input_type -> cloche.v1.ListTasksRequest
	34, // 33: cloche.v1.ClocheService.GetTask:input_type -> cloche.v1.GetTaskRequest
	37, // 34: cloche.v1.ClocheService.GetAttempt:input_type -> cloche.v1.GetAttemptRequest
	9,  // 35: cloche.v1.ClocheService.Shutdown:input_type -> cloche.v1.ShutdownRequest
	11, // 36: cloche.v1.ClocheService.DeleteContainer:input_type -> cloche.v1.DeleteContainerRequest
	13, // 37: cloche.v1.ClocheService.ExtractRun:input_type -> cloche.v1.ExtractRunRequest
	18, // 38: cloche.v1.ClocheService.EnableLoop:input_type -> cloche.v1.EnableLoopRequest
	20, // 39: cloche.v1.ClocheService.DisableLoop:input_type -> cloche.v1.DisableLoopRequest
	22, // 40: cloche.v1.ClocheService.ResumeLoop:input_type -> cloche.v1.ResumeLoopRequest
	24, // 41: cloche.v1.ClocheService.QuiesceRuns:input_type -> cloche.v1.QuiesceRunsRequest
	26, // 42: cloche.v1.ClocheService.GetProjectInfo:input_type -> cloche.v1.GetProjectInfoRequest
	29, // 43: cloche.v1.ClocheService.GetVersion:input_type -> cloche.v1.GetVersionRequest
	39, // 44: cloche.v1.ClocheService.Complete:input_type -> cloche.v1.CompleteRequest
	41, // 45: cloche.v1.ClocheService.GetUsage:input_type -> cloche.v1.GetUsageRequest
	44, // 46: cloche.v1.ClocheService.Console:input_type -> cloche.v1.ConsoleInput
	50, // 47: cloche.v1.ClocheService.GetContextKey:input_type -> cloche.v1.GetContextKeyRequest
	52, // 48: cloche.v1.ClocheService.SetContextKey:input_type -> cloche.v1.SetContextKeyRequest
	54, // 49: cloche.v1.ClocheService.ListContextKeys:input_type -> cloche.v1.ListContextKeysRequest
	56, // 50: cloche.v1.ClocheService.AgentSession:input_type -> cloche.v1.AgentMessage
	69, // 51: cloche.v1.ClocheService.AskHelp:input_type -> cloche.v1.AskHelpRequest
	71, // 52: cloche.v1.ClocheService.ListThreads:input_type -> cloche.v1.ListThreadsRequest
	74, // 53: cloche.v1.ClocheService.GetThread:input_type -> cloche.v1.GetThreadRequest
	77, // 54: cloche.v1.ClocheService.ReplyThread:input_type -> cloche.v1.ReplyThreadRequest
	1,  // 55: cloche.v1.ClocheService.RunWorkflow:output_type -> cloche.v1.RunWorkflowResponse
	3,  // 56: cloche.v1.ClocheService.GetStatus:output_type -> cloche.v1.GetStatusResponse
	6,  // 57: cloche.v1.ClocheService.StreamLogs:output_type -> cloche.v1.LogEntry
	8,  // 58: cloche.v1.ClocheService.StopRun:output_type -> cloche.v1.StopRunResponse
	16, // 59: cloche.v1.ClocheService.ListRuns:output_type -> cloche.v1.ListRunsResponse
	33, // 60: cloche.v1.ClocheService.ListTasks:output_type -> cloche.v1.ListTasksResponse
	36, // 61: cloche.v1.ClocheService.GetTask:output_type -> cloche.v1.GetTaskResponse
	38, // 62: cloche.v1.ClocheService.GetAttempt:output_type -> cloche.v1.GetAttemptResponse
	10, // 63: cloche.v1.ClocheService.Shutdown:output_type -> cloche.v1.ShutdownResponse
	12, // 64: cloche.v1.ClocheService.DeleteContainer:output_type -> cloche.v1.DeleteContainerResponse
	14, // 65: cloche.v1.ClocheService.ExtractRun:output_type -> cloche.v1.ExtractRunResponse
	19, // 66: cloche.v1.ClocheService.EnableLoop:output_type -> cloche.v1.EnableLoopResponse
	21, // 67: cloche.v1.ClocheService.DisableLoop:output_type -> cloche.v1.DisableLoopResponse
	23, // 68: cloche.v1.ClocheService.ResumeLoop:output_type -> cloche.v1.ResumeLoopResponse
	25, // 69: cloche.v1.ClocheService.QuiesceRuns:output_type -> cloche.v1.QuiesceRunsResponse
	28, // 70: cloche.v1.ClocheService.GetProjectInfo:output_type -> cloche.v1.GetProjectInfoResponse
	30, // 71: cloche.v1.ClocheService.GetVersion:output_type -> cloche.v1.GetVersionResponse
	40, // 72: cloche.v1.ClocheService.Complete:output_type -> cloche.v1.CompleteResponse
	42, // 73: cloche.v1.ClocheService.GetUsage:output_type -> cloche.v1.GetUsageResponse
	45, // 74: cloche.v1.ClocheService.Console:output_type -> cloche.v1.ConsoleOutput
	51, // 75: cloche.v1.ClocheService.GetContextKey:output_type -> cloche.v1.GetContextKeyResponse
	53, // 76: cloche.v1.ClocheService.SetContextKey:output_type -> cloche.v1.SetContextKeyResponse
	55, // 77: cloche.v1.ClocheService.ListContextKeys:output_type -> cloche.v1.ListContextKeysResponse
	57, // 78: cloche.v1.ClocheService.AgentSession:output_type -> cloche.v1.DaemonMessage
	70, // 79: cloche.v1.ClocheService.AskHelp:output_type -> cloche.v1.AskHelpResponse
	73, // 80: cloche.v1.ClocheService.ListThreads:output_type -> cloche.v1.ListThreadsResponse
	76, // 81: cloche.v1.ClocheService.GetThread:output_type -> cloche.v1.GetThreadResponse
	78, // 82: cloche.v1.ClocheService.ReplyThread:output_type -> cloche.v1.ReplyThreadResponse
...
func file_cloche_proto_init() {
	...
	file_cloche_proto_msgTypes[44].OneofWrappers = []any{
		(*ConsoleInput_Start)(nil),
		(*ConsoleInput_Stdin)(nil),
		(*ConsoleInput_Resize)(nil),
	}
	file_cloche_proto_msgTypes[45].OneofWrappers = []any{
	...
	file_cloche_proto_msgTypes[57].OneofWrappers = []any{
