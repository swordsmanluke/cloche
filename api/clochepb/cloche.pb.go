...
func (x *OrchestrateResponse) GetDispatched() int32 {
	if x != nil {
		return x.Dispatched
	}
	return 0
...
const file_cloche_proto_rawDesc = "" +
	...
	"\x14container_dead_since\x18\t \x01(\tR\x12containerDeadSince\"\x8c\x01\n" +
	...
	"\fcontainer_id\x18\x06 \x01(\tR\vcontainerId2\xdc\x04\n" +
	"\rClocheService\x12L\n" +
	...
	"\bListRuns\x12\x1a.cloche.v1.ListRunsRequest\x1a\x1b.cloche.v1.ListRunsResponse\x12L\n" +
	"\vOrchestrate\x12\x1d.cloche.v1.OrchestrateRequest\x1a\x1e.cloche.v1.OrchestrateResponse\x12C\n" +
...
var file_cloche_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_cloche_proto_goTypes = []any{
	...
	(*OrchestrateRequest)(nil),      // 9: cloche.v1.OrchestrateRequest
	(*OrchestrateResponse)(nil),     // 10: cloche.v1.OrchestrateResponse
	(*ShutdownRequest)(nil),         // 11: cloche.v1.ShutdownRequest
	(*ShutdownResponse)(nil),        // 12: cloche.v1.ShutdownResponse
	(*DeleteContainerRequest)(nil),  // 13: cloche.v1.DeleteContainerRequest
	(*DeleteContainerResponse)(nil), // 14: cloche.v1.DeleteContainerResponse
...
var file_cloche_proto_depIdxs = []int32{
	...
	9,  // 7: cloche.v1.ClocheService.Orchestrate:input_type -> cloche.v1.OrchestrateRequest
	11, // 8: cloche.v1.ClocheService.Shutdown:input_type -> cloche.v1.ShutdownRequest
	13, // 9: cloche.v1.ClocheService.DeleteContainer:input_type -> cloche.v1.DeleteContainerRequest
	1,  // 10: cloche.v1.ClocheService.RunWorkflow:output_type -> cloche.v1.RunWorkflowResponse
	3,  // 11: cloche.v1.ClocheService.GetStatus:output_type -> cloche.v1.GetStatusResponse
	6,  // 12: cloche.v1.ClocheService.StreamLogs:output_type -> cloche.v1.LogEntry
	8,  // 13: cloche.v1.ClocheService.StopRun:output_type -> cloche.v1.StopRunResponse
	16, // 14: cloche.v1.ClocheService.ListRuns:output_type -> cloche.v1.ListRunsResponse
	10, // 15: cloche.v1.ClocheService.Orchestrate:output_type -> cloche.v1.OrchestrateResponse
	12, // 16: cloche.v1.ClocheService.Shutdown:output_type -> cloche.v1.ShutdownResponse
	14, // 17: cloche.v1.ClocheService.DeleteContainer:output_type -> cloche.v1.DeleteContainerResponse
