...
const file_cloche_proto_rawDesc = "" +
	...
	"\ais_host\x18\b \x01(\bR\x06isHost2\xdc\x04\n" +
	"\rClocheService\x12L\n" +
	...
	"\vOrchestrate\x12\x1d.cloche.v1.OrchestrateRequest\x1a\x1e.cloche.v1.OrchestrateResponseB+Z)github.com/cloche-dev/cloche/api/clochepbb\x06proto3"
...
var file_cloche_proto_depIdxs = []int32{
	...
	10, // 15: cloche.v1.ClocheService.Shutdown:output_type -> cloche.v1.ShutdownResponse
	12, // 16: cloche.v1.ClocheService.DeleteContainer:output_type -> cloche.v1.DeleteContainerResponse
	14, // 17: cloche.v1.ClocheService.Orchestrate:output_type -> cloche.v1.OrchestrateResponse
